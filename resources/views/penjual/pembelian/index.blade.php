        ...
        <fieldset class="border border-gray-400 p-3 rounded-sm mb-3">
          ...
          <div class="flex flex-col sm:flex-row sm:space-x-3">
            ...
            <div class="flex-1 grid grid-cols-[auto_1fr] gap-x-2 gap-y-2 text-xs sm:text-sm">
                ...
                <input id="kode_trx_beli" type="text" value="{{ $lastKodeHariIni }}" readonly class="bg-gray-200 border border-gray-300 rounded-sm px-2 py-1 text-xs sm:text-sm w-[150px]" />

                <label for="id_supplyer" class="text-gray-800 pt-1">Supplyer</label>
                <select id="id_supplayer" name="id_supplayer" class="border border-gray-300 rounded-sm px-2 py-1 text-xs sm:text-sm w-[150px]">
