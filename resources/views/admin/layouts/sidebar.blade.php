<div class="sidebar">
    <ul>
        <li><a href="{{ url('/kelola_admin') }}">Kelola Admin</a></li>
        <li><a href="{{ url('/kelola_penjual') }}">Kelola Penjual</a></li>
        <li><a href="{{ url('/supplyer') }}">Supplyer</a></li>
        <li><a href="{{ url('/stok') }}">Stok Gudang</a></li>
