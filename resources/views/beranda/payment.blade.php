<x-app-layout>
    ...
    <div class="py-8 lg:py-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            {{-- @php
                // Get the latest transaction for current user
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <p class="text-lg font-semibold text-gray-900 font-mono">{{ $transaction->kode_trx_jual }}</p>
                                        </div>
                                        <div>
                                            <label class="text-sm font-medium text-gray-500">Order Date</label>
                                            <p class="text-gray-900">{{ \Carbon\Carbon::parse($transaction->tanggal)->format('d M Y') }}</p>
                                        </div>
                                    </div>
                                    <div class="space-y-4">
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <p class="text-2xl font-bold text-green-600">Rp {{ number_format($transaction->total, 0, ',', '.') }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 sticky top-4">
                            <div class="px-6 py-4 bg-gradient-to-r from-purple-50 to-pink-50 border-b border-gray-100 rounded-t-2xl">
                                <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                            ...
                            <div class="p-6 space-y-4">
                                ...
                                @else
                                    <div class="pt-4">
                                        <div class="w-full bg-gray-100 text-gray-500 font-semibold py-4 px-6 rounded-xl text-center">
